          ...
          <div className="w-full flex items-center justify-center mt-8">
            <div className="text-gray-200 flex items-center max-w-3xl text-justify">
              <p className="pt-5 pr-12 text-2xl">
                ...
                science and profession. With over 100,000 members worldwide, ACM
                brings together educators, researchers, and professionals to
                address the challenges and opportunities in computing. The
                Navrachana University ACM Chapter joins this vast network,
                creating a platform for students and faculty to connect, learn,
